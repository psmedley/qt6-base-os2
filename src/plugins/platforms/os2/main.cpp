...
class QOS2IntegrationPlugin : public QPlatformIntegrationPlugin
{
    Q_OBJECT
...
{
    if (!system.compare(QLatin1String("os2"), Qt::CaseInsensitive))
        return new QOS2Integration(paramList);
