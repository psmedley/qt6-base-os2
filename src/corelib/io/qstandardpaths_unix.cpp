...
static QStringList xdgDataDirs()
{
    ...
    if (dirs.isEmpty()) {
#ifdef Q_OS_OS2
        dirs = QStringList{ QString::fromLatin1("/@unixroot/usr/local/share"),
                            QString::fromLatin1("/@unixroot/usr/share") };
#else
...
static QStringList xdgConfigDirs()
{
    ...
    if (dirs.isEmpty())
#ifdef Q_OS_OS2
        dirs.push_back(QString::fromLatin1("/@unixroot/etc/xdg"));
#else
        dirs.push_back(QString::fromLatin1("/etc/xdg"));
#endif
